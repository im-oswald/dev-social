...
const ProfileForm = ({ edit, saveProfile, profile: { profile, loading }}) => {
  ...
  const onSubmit = e => {
    ...
    saveProfile(formData, navigate, edit);
  }
...
export default connect(mapStateToProps, { saveProfile, getCurrentProfile })(ProfileForm);
